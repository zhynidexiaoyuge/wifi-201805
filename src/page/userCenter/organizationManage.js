...
import * as api from '../../api/api-organizationManage';
    ...
    return (
      <div>
        ...
        <Panel width={1590} height={920} top={40} left={290} animation={"animated fadeInRight"}>
          ...
          <Button left={1240} top={20} data={['添加组织机构','删除组织机构']} changeClick={this.buttonClick.bind(this)} />
    ...
    me._tokens.push(api.tableList.send({}).then(res => {
      try {
        ...
        let Listdata = {
          ...
          thData: ["序号", "名称", "组织机构类型", "直属成员", "所有成员", "所有子机构", "全选"],
